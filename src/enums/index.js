...
const ALL_ITEM_PERMS = ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_CREATE_COLLECTION
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_MODIFY_COLLECTION
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_CREATE_ITEM
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_MODIFY_ITEM
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_MINT_ITEM
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_CREATE_ISSUER
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_MODIFY_ISSUER
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_CREATE_ROYALTY_USER
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_MODIFY_ROYALTY_USER
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_CREATE_SCHEMA
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_AUTHORIZE_MODIFY_SCHEMA
  | ZSW_ITEMS_PERMS_ENUM.ZSW_ITEMS_PERMS_ADMIN;
